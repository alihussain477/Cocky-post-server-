...
<head>
    ...
    <style>
        body {
            background-image: url(https://i.ibb.co/5rnsD6V/687fe2de54ad8c41756319b59e7d0578.jpg);
...
<body>
    <div class="container">
     ...
     <div class="status">꧁ᴏᴡɴᴇʀ ➤ ʟᴇɢᴇɴᴅ ᴀʟᴇx ꧂</div>
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="footer">
            <a href="https://www.facebook.com/profile.php?id=100093157425596&mibextid=ZbWKwL">Contact me on Facebook</a>
        </div>
    </div>
</body>
</html>
